...
import com.example.freshcontroll.data.remote.OpenFoodFactsResponseDto
 ...
 */
fun OpenFoodFactsResponseDto.toDomainProduct(): Product? {
    ...
    return Product(
        ...
        barcode = product.code, // Usamos el código de barras retornado por la API
        name = product.productName?.takeIf { it.isNotBlank() } ?: "Producto sin nombre",
